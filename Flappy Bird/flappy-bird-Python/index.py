...
background_img = pygame.image.load("Flappy Bird/flappy-bird-Python/images/background.png").convert()
bird_img = pygame.image.load("Flappy Bird/flappy-bird-Python/images/bird.png").convert_alpha()
pipe_img = pygame.image.load("Flappy Bird/flappy-bird-Python/images/fullPipeBottom.png").convert_alpha()
